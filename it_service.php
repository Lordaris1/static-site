  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 service_blog">
        <div class="full">
          <div class="service_img"> <img class="img-responsive" src="images/it_service/computer_setup.jpg" alt="#" /> </div>
          <div class="service_cont">
            <h3 class="service_head">Fix Computers</h3>
      ...
      <div class="col-md-4 service_blog">
        <div class="full">
          <div class="service_img"> <img class="img-responsive" src="images/it_service/computer_setup.jpg" alt="#" /> </div>
          <div class="service_cont">
            <h3 class="service_head">Build Computers</h3>
            <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
            <div class="bt_cont"> <a class="btn sqaure_bt" href="#">View Service</a> </div>
          </div>
        </div>
      ...
      <div class="col-md-4 service_blog">
        <div class="full">
          <div class="service_img"> <img class="img-responsive" src="images/it_service/computer_setup.jpg" alt="#" /> </div>
          <div class="service_cont">
            <h3 class="service_head">Upgrade Computers</h3>
            <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
            <div class="bt_cont"> <a class="btn sqaure_bt" href="#">View Service</a> </div>
          </div>
        </div>
