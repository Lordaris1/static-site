          ...
          <div class="full">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="main_heading text_align_center">
                <h2>Login Here to Avail Discount</h2>
              </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 appointment_form">
              <div class="form_section">
                <form class="form_contant" action="includes/login.inc.php" method="post">
                ...
                <?php 
                 ...
                 ?>
                  ...
                  <div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <input class="field_custom" placeholder="Username" type="text" required name="uname">
                  </div>
                  <div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="center">
                    <button  type="submit" name = "submit" class="btn main_bt">Login</button>
                  </div>
                  </fieldset>
                </form>
              </div>
