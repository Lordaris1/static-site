...
<div class="section padding_layout_1">
          ...
          <div class="full">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 appointment_form">
              <div class="form_section">
                <form class="form_contant" action="includes/signup.inc.php" method="POST">
  ...
  ?>
                  ...
                  <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <input class="field_custom" placeholder="Username*" type="text" required name="username">
                  </div>
                  <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <input class="field_custom" placeholder="Email" type="email" required name="email">
                  </div>
                  <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <input class="field_custom" placeholder="Password" type="password" required name="psw">
                  </div>
                  <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <input class="field_custom" placeholder="Confirm Password" type="password" required name="psw-repeat">
                  </div>
                
                  <div class="center">
                    <button type="submit" name = "submit" class="btn main_bt">REGISTER</button>
                  </div>
                  </fieldset>
                </form>
              </div>
